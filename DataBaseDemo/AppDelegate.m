...
- (NSManagedObjectModel *)managedObjectModel
{
    ...
    //这里一定要注意，这里的testCoreData就是你刚才建立的数据模型的名字，一定要一致。否则会报错。
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator
{
    ...
    //这里的testCoreData.sqlite，也应该与数据模型的名字保持一致。
    NSURL *storeURL = [[self getDocumentsDirectory]URLByAppendingPathComponent:@"testCoreData.sqlite"];
